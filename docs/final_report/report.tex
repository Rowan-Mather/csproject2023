...
\begin{figure}[H]
    \centering
    \includegraphics[width=650pt, angle=90]{figures/introduction/Existing work table.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.36\textwidth]{figures/implementation/importing/basicico.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/implementation/importing/objectclassdiagram.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/implementation/importing/ballandconelabelled.jpg}
...
\begin{figure}[h]
\centering
    \includegraphics[width=0.75\linewidth]{figures/testing/Rowan Mather - Lovelace Poster.pdf}
