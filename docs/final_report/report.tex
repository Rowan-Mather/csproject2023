...
\begin{figure}
    \includegraphics[width=640pt, angle=90]{figures/projectmanagement/gantt3.pdf}
        \caption{Initial Specification Gantt Chart}
        \label{fig:gantt1}
\end{figure}

\begin{figure}
    \includegraphics[width=640pt, angle=90]{figures/projectmanagement/ganttpanic.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/design/contextmodel2.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.72\linewidth]{figures/design/mainmenu.jpg}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.72\linewidth]{figures/design/helpscreen.jpg}
\end{minipage}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.72\linewidth]{figures/design/updatedmanualdesign.jpg}

\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.72\linewidth]{figures/design/updatedmanualsidebar.jpg}
\end{minipage}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/design/updatedlivedesign.jpg}
